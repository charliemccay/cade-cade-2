...
digital_exhaust_template_dir = "resources/files/exhaust_templates/"
...
population_file_path = "resources/files/populations/start_population 50.csv"
...
nodes_list_file = "resources/files/visualisations/NodesList.csv"
...
is_log_to_google_cloud = False

# path to json key which was generated in google cloud platform (see google sheets guide)
path_sheets_auth_key = 'resources/nameforguide-e8f08894d3de.json'
# email for google sheets to give owner permission to
email_sheets = 'charlie@ramseysystems.co.uk'
# spreadsheet name you want to log event
# can be the same as connection sheet name
# leave empty if you want logs to be separated - if would have generated uniq name
sheet_name = 'some new name'

# used to speed up writing info to google sheet
# how many rows appears in worksheet at once
rows_in_bunch_to_gh = 15
# default spreadsheet size is 1000 rows
# will increase by this number of rows if it's not enough
rows_to_extend_gh = 200
